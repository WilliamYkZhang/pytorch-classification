...
if __name__ == '__main__':
    ...
    batch_options = [16,   32,   64,   96,   128,   160,  192,   224,  256,  320]
    ...
    parser.add_argument('--schedule', type=int, nargs='+', default=[500, 750],
    ...
    # Checkpoints
    parser.add_argument('-c', '--checkpoint', default="/checkpoints/undeclared", type=str, metavar='PATH',
    ...
    #     learning_rate = lr_simplified[0]
    #     checkpoint = "checkpoints/cifar100/vgg19/LR_{}_BS_{}".format(learning_rate, batch)
    #     parser = argparse.ArgumentParser(description='PyTorch CIFAR10/100 Training')
    #     # Datasets
    #     parser.add_argument('-d', '--dataset', default='cifar100', type=str)
    #     parser.add_argument('-j', '--workers', default=4, type=int, metavar='N',
    ...
    #     parser.add_argument('--start-epoch', default=0, type=int, metavar='N',
    #                         help='manual epoch number (useful on restarts)')
    #     parser.add_argument('--train-batch', default=batch, type=int, metavar='N',
    #                         help='train batchsize')
    #     parser.add_argument('--test-batch', default=batch, type=int, metavar='N',
    #                         help='test batchsize')
