...
if __name__ == '__main__':
    ...
    batch_options = [32, 96, 128, 160, 192, 224, 256, 320]
    for batch in batch_options:
        for learning_rate in lr_simplified:
            checkpoint = "checkpoints/cifar10/vgg19/LR_{}_BS_{}".format(learning_rate,batch)
            ...
            # Checkpoints
            parser.add_argument('-c', '--checkpoint', default='checkpoints/cifar10/vgg19', type=str, metavar='PATH',
